...
var ModEngineRuntime = (function(){
    ...
    function cancelBuildSelection(){
        ...
        selectedBuilds = [];
        try{ if(ui.hideBuildSelection) ui.hideBuildSelection(); }catch(eHideDialog){}
    ...
    function beginBuildSelection(){
        ...
        try{ if(quickHudRoot != null) quickHudRoot.toFront(); }catch(e){}
        try{ if(hudRoot != null) hudRoot.toFront(); }catch(e){}
        try{ if(speedHudRoot != null) speedHudRoot.toFront(); }catch(e){}
